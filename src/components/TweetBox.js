    ...
    const sendTweet = () => {
        if (content !== "") {
          db.collection("feed").add({
            displayName: "Betül Yanal",
            username: "@betullynl",
            content,
            timestamp: firebase.firestore.FieldValue.serverTimestamp(),
            image:
              "https://64.media.tumblr.com/7a6c2707fec7edc93f6a3d91cdf98d37/52f8b9b215dc4675-ff/s250x400/9d0609b02754cd5758d0e3f495ff27ab40c51353.gifv",
